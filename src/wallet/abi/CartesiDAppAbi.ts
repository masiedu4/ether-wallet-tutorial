export const CartesiDAppAbi = [
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "_templateHash", type: "bytes32" },
    ],
    stateMutability: "nonpayable",
    type: "constructor",
  },
  { inputs: [], name: "EtherTransferFailed", type: "error" },
  { inputs: [], name: "IncorrectEpochHash", type: "error" },
  { inputs: [], name: "IncorrectOutputHashesRootHash", type: "error" },
  { inputs: [], name: "IncorrectOutputsEpochRootHash", type: "error" },
  { inputs: [], name: "InputIndexOutOfClaimBounds", type: "error" },
  { inputs: [], name: "OnlyDApp", type: "error" },
  { inputs: [], name: "VoucherReexecutionNotAllowed", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    ...
    name: "getConsensus",
    outputs: [
      { internalType: "contract IConsensus", name: "", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes", name: "_notice", type: "bytes" },
      {
        components: [
          {
            components: [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_inputIndex", type: "uint256" },
      {
        internalType: "uint256",
